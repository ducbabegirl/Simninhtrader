        ...
        <div class="container max-w-6xl mx-auto px-3 h-full">
            <div class="border-b flex items-center h-full">
                ...
                <ul class="flex-1 items-center hidden md:flex">
                    ...
                    <li class="${pageName === "" ? "text-black" : ""} pr-4 font-semibold text-gray-500 transition ease-linear duration-200 hover:text-black">
                        <a href="/#/">Giới thiệu</a>
                    </li>
                ...
                <div class="h-full">
                    <a href="/#/" class="block h-full py-2">
                        <img class="block h-full" src="https://res.cloudinary.com/ddxwrjamy/image/upload/v1686650479/logo_sim_ninh_u6b7j1.png" alt="">
                    </a>
                </div>
                ...
                <ul class="flex flex-1 justify-end md:hidden">
                    <li class="uppercase text-base cursor-pointer pl-6 text-gray-600 font-light opacity-80 transition ease-linear duration-200 hover:text-black hover:opacity-100">
                        <div class="relative">
                            <label for="" class="text-white absolute w-4 h-4 bg-green-700 text-xs text-center rounded-full -right-3 -top-1">0</label>
