...
const FormComment = {
    async render(productId) {
        ...
        return /* html */`
        <div>
            <h2 class="mt-3 font-semibold text-xl">Đánh giá Nào</h2>
            ...
            <form action="" class="px-3 py-2 border-2 border-[#D9A953] mt-3" id="form__comment">
                ...
                <button class="my-3 px-4 py-2 bg-[#f59e0b] font-semibold uppercase text-white text-sm transition ease-linear duration-300 hover:shadow-[inset_0_0_100px_rgba(0,0,0,0.2)]">Gửi đi</button>
            </form>
        </div>
        `;
    },
