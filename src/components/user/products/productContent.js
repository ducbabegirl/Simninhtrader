                    ...
                    ${productList.map((item) => /* html */`
                        <div class="group product-item" data-id="${item.id}">
                            <div class="relative bg-[#f7f7f7] overflow-hidden">
                                ...
                                <button class="absolute w-full bottom-0 h-9 bg-[#ffbf00] text-center text-gray-50 opacity-95 uppercase font-semibold text-sm transition ease-linear duration-300 hover:opacity-100 hover:text-white translate-y-full group-hover:translate-y-0">Xem nhanh</button>
