...
const Header = {
    async render(pageName) {
        ...
        <header>
            <!-- header top -->
            <div class=" bg-[#ffbf00]  hidden md:block">
            ...
            <section class="nav__mobile invisible transition-all duration-500 ease-linear fixed top-0 right-0 bottom-0 left-0 z-20">
                ...
                <nav class="nav__mobile-content -translate-x-full transition duration-500 ease absolute top-0 left-0 bottom-0 min-w-[260px] bg-[rgba(255,255,255,0.95)] shadow py-10">
                    ...
                    <ul class="grid grid-cols-1 divide-y mt-5">
                        ...
                        <li>
                            <a href="/#/" class="px-3 py-3.5 transition ease-linear duration-200 hover:bg-gray-200 text-sm font-semibold text-gray-500 hover:text-black uppercase block">Giới thiệu</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="/#/" class="px-3 py-3.5 transition ease-linear duration-200 hover:bg-gray-200 text-sm font-semibold text-gray-500 hover:text-black uppercase block">Tin tức</a>
                        </li>
                        <li>
