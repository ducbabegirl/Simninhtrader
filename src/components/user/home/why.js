...
import { add, checkHeart } from "../../../api/favoritesProduct.js";
...
const Why = {
    async render() {
        ...
        <section class="container max-w-6xl mx-auto py-9 px-3">
            ...
            <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl text-center mt-2">KIẾN THỨC TỪ SÁCH</h1>
            <br>
                ...
                ${listProduct.map((item) => `
                    <div class="group">
                        <div class="relative bg-[#f7f7f7] overflow-hidden">
                            ...
                            <button class="absolute w-full bottom-0 h-9 bg-[#fbbf24] text-center text-gray-50 opacity-95 uppercase font-semibold text-sm transition ease-linear duration-300 hover:opacity-100 hover:text-white translate-y-full group-hover:translate-y-0">Xem nhanh</button>
