        ...
        <main>
            <section class="container max-w-6xl mx-auto px-3">
                ...
                <form action="" class="mb-14" method="POST" id="form__login">
                    ...
                    <button class="select-none mt-4 px-3 py-2 bg-[#ffbf00] font-semibold uppercase text-white text-sm transition ease-linear duration-300 hover:shadow-[inset_0_0_100px_rgba(0,0,0,0.2)]">Đăng nhập</button>
