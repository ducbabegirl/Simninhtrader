...
const ProductDetailPage = {
    async getTitle(id) {
        ...
        return `${productDetail.name} - SimNinh`;
    },
        ...
        <main>
                ...
                <div>
                    <div class="flex justify-between">
                        <div>
                            ...
                            <div class="mt-1 my-2">
                                <span class="text-3xl text-[bg-amber-500] font-semibold">${formatCurrency(productDetail.price)}</span>
                            </div>
                        </div>
                        <ul class="flex">
                            <li>
                            ...
                            <form action="" id="form__add-cart" data-id="${id}">
                                <div class="border-b border-dashed pb-4 mt-6">
                                    ...
                                    <div class="flex mt-2 items-center">
                                        ...
                                        <button id="form__add-cart-btn" class="ml-2 px-3 py-2 bg-amber-400 font-semibold uppercase text-white text-sm transition ease-linear duration-300 hover:shadow-[inset_0_0_100px_rgba(0,0,0,0.2)]">Thêm vào giỏ hàng</button>
                                    </div>
                                </div>
                            </form>
            ...
            <section class="container max-w-6xl mx-auto px-3">
                <ul class="flex border-t">
                    ...
                    <li class="transition ease-linear duration-200 font-bold cursor-pointer hover:border-t-[#D9A953] hover:text-black uppercase pt-2 border-t-2 border-t-[#D9A953] pr-2 text-black text-xs">Đánh giá xin</li>
                </ul>
            </section>
            ...
            <section class="container max-w-6xl mx-auto px-3">
                ...
                <div class="mt-5">
                    Vui lòng
                    <a href="/#/login">
                        <button class="bg-[#ffbf00] px-2 py-1 rounded text-white text-sm font-semibold transition duration-200 ease-linear hover:shadow-[inset_0_0_100px_rgba(0,0,0,0.2)]">đăng nhập</button>
                    </a>
                    để nhận xét
                </div>
                `}
